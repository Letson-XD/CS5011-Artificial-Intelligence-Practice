 ...
 */
 ...
 public enum World {
	...
	//----------TEST BOARDS FOR THE SQUARE FORMAT-----------
	SQUARETEST1(new char[][] {
		{'0', '0', '0'}, 
		{'2', '3', '2'}, 
		{'t', 't', 't'}}), 
	SQUARETEST2(new char[][] {
		{'2', 't', 't'}, 
		{'t', '5', 't'}, 
		{'1', '3', 't'}}),
	SQUARETEST3(new char[][] {
		{'0', '0', '0'}, 
		{'1', '1', '1'}, 
		{'1', 't', '1'}}),
	SQUARETEST4(new char[][] {
		{'0', '1', 't'}, 
		{'0', '2', '2'}, 
		{'0', '1', 't'}}),
	SQUARETEST5(new char[][] {
		{'0', '1', 't'}, 
		{'0', '1', '1'}, 
		{'0', '0', '0'}}),
	SQUARETEST6(new char[][] {
		{'0', '0', '0'}, 
		{'1', '2', '2'}, 
		{'1', 't', 't'}}),
